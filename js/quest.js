const levelQuest = {
    ...
    quest() {
        const level = 5
        const message = {
            start: `마을에 몬스터가 출몰해 주민들을 좀비로 만들고 있다. 몬스터를 사냥해서 주민을 구하고 <span>레벨을 ${level} 이상</span>으로 만들어 힘을 증명한다면 좀비왕을 물리칠 수 있도록 내 힘을 빌려줄께!`,
...
const levelQuestTwo = {
    positionX: 8500,
    idleMessage: ' <p>곧 좀비왕이 부활하려고 해</br><span>대화 Enter</span></p>',
    quest() {
        const level = 7
        const message = {
            start: `마을에 몬스터가 출몰해 주민들을 좀비로 만들고 있다. 몬스터를 사냥해서 주민을 구하고 <span>레벨을 ${level} 이상</span>으로 만들어 힘을 증명한다면 좀비왕을 물리칠 수 있도록 내 힘을 빌려줄께!`,
